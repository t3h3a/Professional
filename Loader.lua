...
local Theme, Physics, Targeting, UI
local success = pcall(function()
	Theme = CloudRequire("Theme_Config.lua")
	Physics = CloudRequire("Physics_Module.lua")
	Targeting = CloudRequire("Targeting_Module.lua")
	UI = CloudRequire("UI_Module.lua", { Theme = Theme, CoreGui = CoreGui })
end)

if not success then error("Failed to load modular system from GitHub.") end
